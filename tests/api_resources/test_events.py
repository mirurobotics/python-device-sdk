...
class TestEvents:
    ...
    @parametrize
    def test_method_stream(self, client: Miru) -> None:
        event_stream = client.events.stream()
        event_stream.response.close()

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_stream_with_all_params(self, client: Miru) -> None:
        event_stream = client.events.stream(
            after=0,
            types=["string"],
            last_event_id="42",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_stream(self, client: Miru) -> None:
...
class TestAsyncEvents:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_stream(self, async_client: AsyncMiru) -> None:
        event_stream = await async_client.events.stream()
        await event_stream.response.aclose()

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_stream_with_all_params(self, async_client: AsyncMiru) -> None:
        event_stream = await async_client.events.stream(
            after=0,
            types=["string"],
            last_event_id="42",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_stream(self, async_client: AsyncMiru) -> None:
